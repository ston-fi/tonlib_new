...
async fn test_get_jetton_metadata_complex() -> anyhow::Result<()> {
    ...
    assert_get_jetton_content_uri(&ctr_cli).await?;
    assert_get_jetton_content_internal_uri(&ctr_cli).await?;
    assert_get_jetton_content_internal_uri_jusdt(&ctr_cli).await?;
    assert_get_jetton_content_empty_external_meta(&ctr_cli).await?;
    assert_get_jetton_data_invalid_utf8_sequence(&ctr_cli).await?;
    assert_get_semi_chain_layout_jetton_content(&ctr_cli).await?;
    assert_get_wallet_address(&ctr_cli).await?;
    assert_jetton_image_data(&ctr_cli).await?;

    Ok(())
}

async fn assert_get_jetton_content_uri(ctr_cli: &ContractClient) -> anyhow::Result<()> {
...
async fn assert_get_jetton_content_internal_uri_jusdt(ctr_cli: &ContractClient) -> anyhow::Result<()> {
...
async fn assert_get_jetton_content_empty_external_meta(ctr_cli: &ContractClient) -> anyhow::Result<()> {
...
async fn assert_get_semi_chain_layout_jetton_content(ctr_cli: &ContractClient) -> anyhow::Result<()> {
...
async fn assert_get_wallet_address(ctr_cli: &ContractClient) -> anyhow::Result<()> {
...
async fn assert_get_jetton_data_invalid_utf8_sequence(ctr_cli: &ContractClient) -> anyhow::Result<()> {
...
async fn assert_jetton_image_data(ctr_cli: &ContractClient) -> anyhow::Result<()> {
