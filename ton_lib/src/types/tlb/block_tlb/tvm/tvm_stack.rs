...
use crate::types::tlb::block_tlb::tvm::{TVMCell, TVMCellSlice, TVMInt, TVMStackValue, TVMTinyInt, TVMTuple};
...
impl TVMStack {
    ...
    pub fn pop_tuple(&mut self) -> Result<TVMTuple, TonlibError> {
        match self.pop() {
            None => Err(TonlibError::TVMStackEmpty),
