...
mod test {
    ...
    use crate::types::ton_wallet::constants::DEFAULT_USER_WALLET_ID;
    use crate::types::ton_wallet::constants::{DEFAULT_USER_WALLET_ID_V5R1, DEFAULT_USER_WALLET_ID_V5R1_TESTNET};
