...
fn pbkdf2_sha512(key: Vec<u8>, salt: &str, rounds: u32, output_len_bytes: usize) -> Result<Vec<u8>, TonlibError> {
    let params = Params {
        rounds,
    ...
    .map_err(|err| TonlibError::MnemonicPassHashError(err.to_string()))?;
