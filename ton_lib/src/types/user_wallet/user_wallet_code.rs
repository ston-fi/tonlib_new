...
lazy_static! {
    #[allow(clippy::all)]
    pub static ref USER_WALLET_CODE_BY_VERSION: HashMap<UserWalletVersion, TonCellRef> =
        HashMap::from([
            ...
            (HighloadV1R1, load_code!("../../../resources/user_wallet_code/highload_v1r1.code")),
            (HighloadV1R2, load_code!("../../../resources/user_wallet_code/highload_v1r2.code")),
            (HighloadV2, load_code!("../../../resources/user_wallet_code/highload_v2.code")),
            (HighloadV2R1, load_code!("../../../resources/user_wallet_code/highload_v2r1.code")),
            (HighloadV2R2, load_code!("../../../resources/user_wallet_code/highload_v2r2.code")),
        ]);
}
