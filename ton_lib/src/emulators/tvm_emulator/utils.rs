...
//         //     ] }
//         // ] }
//         let root_cell = CellBuilder::new().store_u64(24, 0)?.store_reference(&EMPTY_ARC_CELL.clone())?.build()?;
//         root_cell
//     } else {
...
// }
//
// fn store_stack_entry(builder: &mut CellBuilder, entry: &TvmStackEntry) -> Result<(), TvmEmulatorError> {
//     match entry {
//         TvmStackEntry::Null => {
...
//             Err(TvmEmulatorError::EmulatorError("EmulatorStackEntry::Unsupported is not supported".to_string()))
//         }
//     }
// }
