...
use crate::clients::tonlib::tl::stack::{TvmCell, TvmStack};
...
impl InternalTransactionId {
    const ZERO: InternalTransactionId = InternalTransactionId {
        lt: 0i64,
        hash: TonHash::ZERO,
    };
}
...
impl BlocksAccountTransactionId {
    const ZERO: BlocksAccountTransactionId = BlocksAccountTransactionId {
...
mod tests {
    ...
    use crate::clients::tonlib::tl::types::SmcMethodId;
