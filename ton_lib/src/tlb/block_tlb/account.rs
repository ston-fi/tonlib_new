...
use crate::tlb::block_tlb::coins::{CurrencyCollection, Grams};
use crate::tlb::block_tlb::msg_address::MsgAddressInt;
...
mod tests {
    ...
    use crate::tlb::block_tlb::msg_address::MsgAddressIntStd;
