...
use crate::tlb::primitives::ConstLen;
...
pub struct TLBStateInit {
    pub split_depth: Option<ConstLen<u8, 5>>,
    pub tick_tock: Option<TLBTickTock>,
...
mod tests {
    ...
    use crate::tlb::block::state_init::TLBStateInit;
    use crate::tlb::tlb_type::TLBType;
    use std::ops::Deref;
    ...
    fn test_state_init_regular_contract() -> anyhow::Result<()> {
        ...
        let parsed_state_init = TLBStateInit::from_cell(&source_cell)?;
        ...
        let parsed_back = TLBStateInit::from_cell(&serial_cell)?;
