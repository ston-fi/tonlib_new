...
mod tests {
    ...
    fn test_meta_snake_format_in_ref_cell() -> anyhow::Result<()> {
        let cell = TonCell::from_boc_hex("b5ee9c7201010101004700008a344143324433313934393942414233333131413945433532443946453533334442373945334631303231324334423845384432443144454137433843333034452e6a736f6e")?;
